"""
RealForce O6 hand-shape mapping module - pure Python version
andROS1 O6versions remain consistent, Supports precise mapping based on calibration data
...
class RightHand:
    def __init__(self, handcore: HandCore, length=6, is_debug: bool = False):
        ...
        # self.robot_fist[0] = 1.5 # Lock thumb rotation at a maximum of 0.2; values above 0.2 are unused
        self.robot_fist[0] = 1.1 # Lock thumb abduction at a maximum of 1.2; values above 1.2 are unused
