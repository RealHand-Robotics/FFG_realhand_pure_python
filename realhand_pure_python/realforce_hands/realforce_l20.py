"""
RealForce L20 hand-shape mapping module - pure Python version
"""
...
class RightHand:
    def __init__(self, handcore: HandCore, length=20, is_debug: bool = False):
        ...
        # self.robot_fist[0] = -0.2 # Lock thumb rotation at a maximum of 0.2; values above 0.2 are unused
        # self.robot_fist[1] = 1.4 # Lock thumb abduction at a maximum of 1.2; values above 1.2 are unused
    ...
    def initialize_mapper(self) -> bool:
        ...
        """
        # Preprocess the abduction component
        for i in [5, 9, 13, 17]:
    ...
    def joint_update(self, joint_arc):
        ...
        # ========== Use manual mapping when calibration data is unavailable ==========
            ...
            # Thumb handling (andO6the same)
            qpos[20] = joint_arc[4] * 2.2   # thumb flexion
            qpos[17] = joint_arc[2] * -2.5  # thumb abduction
            # Four-finger handling
...
class LeftHand:
    def __init__(self, handcore: HandCore, length=20, is_debug: bool = False):
        ...
        self.robot_fist[0] = 0.3 # Lock thumb rotation at a maximum of 0.2; values above 0.2 are unused
        # self.robot_fist[1] = 1.5 # Lock thumb abduction at a maximum of 1.2; values above 1.2 are unused
